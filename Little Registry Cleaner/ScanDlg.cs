    ...
    public partial class ScanDlg : Form
    {
        ...
        private void StartScanning()
        {
            ...
            finally
            {
                ...
                TaskbarManager.SetProgressState(this.Handle, TaskbarProgressBarStatus.NoProgress);
        ...
        {
            TaskbarManager.SetProgressValue(this.Handle, (ulong)currentValue, (ulong)maxValue);
        }
